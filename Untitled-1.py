...
dlansink@L-IT-LAPTOP01:~/.ansible/collections/ansible_collections/netbox/netbox/tests/integration$
dlansink@L-IT-LAPTOP01:~/.ansible/collections/ansible_collections/netbox/netbox/tests/integration$ cat netbox-deploy.py
#!/usr/bin/env python
